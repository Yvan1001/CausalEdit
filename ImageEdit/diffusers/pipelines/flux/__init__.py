...
try:
    ...
    _import_structure["pipeline_flux_rf_solver"] = ["RfSolverFluxPipeline"]
    _import_structure["pipeline_flux_rf_solver_new"] = ["RfSolverFluxPipelineNew"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    try:
        ...
        from .pipeline_flux_rf_solver import RfSolverFluxPipeline
        from .pipeline_flux_rf_solver_new import RfSolverFluxPipelineNew
