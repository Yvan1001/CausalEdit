...
if is_torch_available():
    ...
    _import_structure["transformers.transformer_flux"] = ["FluxTransformer2DModel","RfSolverFluxTransformer2DModel","RfSolverFluxTransformer2DModelNew"]
...
if TYPE_CHECKING or DIFFUSERS_SLOW_IMPORT:
    if is_torch_available():
        ...
        from .transformers import (
            ...
            RfSolverFluxTransformer2DModelNew,
